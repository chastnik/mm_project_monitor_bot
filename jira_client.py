...
class JiraClient:
    ...
    def connect(self):
        ...
        logger.warning(
            "Глобальное подключение к Jira отключено. Используйте UserJiraClient для работы с персональными настройками."
        )
        return False
    ...
    def get_user_by_email(self, email: str) -> dict | None:
        ...
        logger.warning(
            "Метод get_user_by_email отключен. Используйте UserJiraClient для работы с персональными настройками."
        )
        return None
    ...
    def test_connection(self) -> bool:
        ...
        logger.warning(
            "Метод test_connection отключен. Используйте UserJiraClient для работы с персональными настройками."
        )
        return False
