...
class MattermostClient:
    ...
    def connect(self):
        ...
        try:
            ...
            # Простая проверка подключения без лишних API вызовов
            self.driver.login()
            ...
            logger.info("DM каналы будут создаваться по мере необходимости")
...
Спасибо за внимание к планированию! 📊"""
    ...
    # Метод _init_direct_channels удален - DM каналы создаются по мере необходимости
...
def get_mattermost_client():
    ...
    global mattermost_client
    if mattermost_client is None:
        mattermost_client = MattermostClient()
    return mattermost_client
