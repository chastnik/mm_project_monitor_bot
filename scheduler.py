...
class StandupScheduler:
    ...
    def run_daily_monitoring(self):
        ...
        try:
            ...
            error_message = f"❌ Ошибка при мониторинге проектов: {e!s}"
    ...
    def _send_channel_report(
        self, users_with_data: list[str], users_without_data: list[str], report_type: str = "worklog"
    ):
    ...
    def run_manual_check(self) -> str:
        ...
        try:
            ...
            error_msg = f"❌ Ошибка при ручной проверке: {e!s}"
